    ...
    render() {
        return (
            <div>
                <div>
                    {/* Page info */}
                    <div className="page-info-section set-bg" style={{ backgroundImage: `url(img/page-bg/3.jpg)` }}>
                            ...
                            <div className="row">
                                <div className="col-lg-9">
                                    ...
                                    <div className="blog-post">
                                        <img src="img/blog/1.jpg"alt="anh" />
                                    ...
                                    {/* blog post */}
                                    <div className="blog-post">
                                        <img src="img/blog/2.jpg"alt="anh" />
                                    ...
                                    {/* blog post */}
                                    <div className="blog-post">
                                        <img src="img/blog/3.jpg"alt="anh" />
                                ...
                                <div className="col-lg-3 col-md-5 col-sm-9 sidebar">
                                    ...
                                    <div className="sb-widget-item">
                                        <div className="add">
                                            <a href="/"><img src="img/add.jpg"alt="anh" /></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
